#!/usr/bin/env node
/**
 * Release script for pi-extention-monorepo
 *
 * Usage:
...
function getVersion() {
	// Read version from first package found; all are lockstep
	...
	const pkg = JSON.parse(readFileSync(join(packagesDir, dirs[0], "package.json"), "utf-8"));
	return pkg.version;
}
